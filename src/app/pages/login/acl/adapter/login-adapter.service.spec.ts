...
describe('LoginAdapterService', () => {
  ...
  it('deve converter contrato de resposta para dto', () => {
    const contract = { message: 'Login realizado com sucesso!', access_token: 'token', expires_in: 12312312312 };
    const result = service.toDto(contract);
    expect(result).toEqual({ message: 'Login realizado com sucesso!', access_token: 'token', expires_in: 12312312312 });
  });
